...
const electricityData = [
  ...
  { month: 'Mrt.', '2022': 62000, '2023': 75000, '2024': 72000 },
  { month: 'Apr.', '2022': 58000, '2023': 70000, '2024': 68000 },
  { month: 'Mei', '2022': 72000, '2023': 85000, '2024': 85000 },
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex flex-wrap w-full mb-6">
            ...
            <div className="w-1/5 p-4">
              ...
              {/* Building image */}
              <div className="bg-white rounded-lg shadow mb-6 overflow-hidden flex justify-center items-center" style={{ height: '295px' }}>
                <img 
                  src={woerdenImage}
                  alt="Woerden kantoor" 
              ...
              <div className="bg-white rounded-lg shadow p-4 mb-6 " style={{ height: "104px" }}>
            ...
            <div>
              ...
              <div className="bg-white rounded-lg shadow p-4 mb-6">
                <div className="text-lg font-medium mb-4">Maandelijks elektraverbruik [kWh]</div>
              ...
              {/* Monthly gas chart */}
              <div className="bg-white rounded-lg shadow p-4">
                <div className="text-lg font-medium mb-4">Maandelijks gasverbruik [m3]</div>
                <ResponsiveContainer width="100%" height={220}>
